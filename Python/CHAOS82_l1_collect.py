...
def my_calc_par(thetaphi_g):
    ...
    for cmpt in run_components:
        ...
        dBr, dBt, dBp = model.synth_values_tdep(mjd, radius, theta_l, phi_l, nmax=1, deriv=1)
...
if __name__ == '__main__':
    ...
    import pickle
    with open("Jerks_CHAOS82_l1_abserror_3_5x5_{0:1d}M.results".format((NSAMPLE-burn_in)//1000000), "wb") as fp:   #Pickling
    # export meta data
