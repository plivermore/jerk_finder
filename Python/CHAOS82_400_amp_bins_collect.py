...
model = cp.load_CHAOS_matfile('/Users/earpwl/Library/CloudStorage/OneDrive-UniversityofLeeds/home/models/CHAOS-8/CHAOS-8.2.mat')  # load model


time = np.linspace(1999, 2025, 3*(2025-1999)+1)  # decimal years
...
def my_calc_par(thetaphi_g):
    ...
    for cmpt in run_components:
        ...
        jerks_info = find_jerks(data_timing, data_amplitude, number_time_bins, time_range, number_amplitude_bins=400)
...
if __name__ == '__main__':
    ...
    import pickle
    with open("Jerks_CHAOS82_abserror_3_400_amp_bins_5x5_{0:1d}M.results".format((NSAMPLE-burn_in)//1000000), "wb") as fp:   #Pickling
    # export meta data
